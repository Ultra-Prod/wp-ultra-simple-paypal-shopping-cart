...
function print_wpus_shopping_cart( $step="paypal", $type="page") {
	...
	*/
	...
	$email                     = (!empty(get_bloginfo('admin_email')))?         get_bloginfo('admin_email')         : '';
	$use_affiliate_platform    = (!empty(get_option('wp_use_aff_platform')))?   get_option('wp_use_aff_platform')   : '';
	$defaultCurrency           = (!empty(get_option('cart_payment_currency')))? get_option('cart_payment_currency') : '';
	$defaultSymbol             = (!empty(get_option('cart_currency_symbol')))?  get_option('cart_currency_symbol')  : '';
	$defaultEmail              = (!empty(get_option('cart_paypal_email')))?     get_option('cart_paypal_email')     : '';
	$cart_validation_url       = (!empty(get_option('cart_validate_url')))?     get_option('cart_validate_url')     : '';

	$display_vat               = (!empty(get_option('display_vat')))?           get_option('display_vat')           : '';
